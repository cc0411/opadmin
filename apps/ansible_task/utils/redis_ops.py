...
class RedisOps:
    ...
    def lpop(self, rediskey):
        ...
        try:
            ...
            logger.error("获取数据（lpop）失败：{}".format(e))
    ...
    def rpop(self, rediskey):
        ...
        try:
            ...
            logger.error("获取数据（rpop）失败：{}".format(e))
    ...
    def lrange(self, rediskey):
        ...
        try:
            ...
            logger.error("获取数据（lrange）失败：{}".format(e))
    ...
    def get(self, rediskey):
        try:
            ...
            logger.error("获取数据（get）失败：{}".format(e))
    ...
    def mget(self, *args):
        try:
            ...
            logger.error("获取多个数据（mget）失败：{}".format(e))

    def sadd(self, rediskey, *values):
        try:
            self.redis_conn.sadd(rediskey, *values)
        except Exception as e:
            logger.error("设置数据集合失败：{}".format(e))
    ...
    def smembers(self, rediskey):
        try:
            ...
            logger.error("获取数据集合失败：{}".format(e))
